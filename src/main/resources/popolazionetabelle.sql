...
VALUES
    ...
    ('M', false, '1995-06-12', 'VRD46TTTERSAS30', 'Verdi', 'Luca');
...
VALUES
    ...
    ('2026-12-31', false, 2, 2, 1, 0, 'luca', 'test', 'lverdi');
...
select * from wksp_taskman.progetto_x_anagrafica;
